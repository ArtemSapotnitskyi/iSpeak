...
// Courses - general EN
{
  ...
  title: "Для дітей",
  price: "₴450/Урок",
  description: "Заняття з викладачем у стаціонарному форматі відповідно до твого рівня. Базова граматика, слова та прості розмови.",
  tags: [
    "Рівень: A1-A2",
...

{
  ...
  price: "₴450/Урок",
  description: "Заняття з викладачем у стаціонарному форматі відповідно до твого рівня. Базова інтенсивна граматика, слова та прості розмови.",
  tags: [
    "Рівень: A1-A2",
    "2 уроки/тиждень по 45 хв",
    "Доступ до додатку"
...

{
  ...
  price: "₴450/Урок",
  description: "Заняття з викладачем у стаціонарному форматі відповідно до твого рівня. Середній рівень, впевнене складання речень та розуміння англійської.",
  tags: [
    "Рівень: A2-B1",
    "2 уроки/тиждень по 45 хв",
    "Доступ до додатку"
